				     ...
				     struct key_params *params)
{
	...
	if (remove) {
		...
		if (wdev->current_bss) {
            ...
            // Add by Henry to sync cfg80211.h->cfg80211_ops with gl_p2p_cfg80211.c
            // mtk_p2p_cfg80211_del_key of MT5931_MP_Linux_P2P_W1233_V1.0 infact doesn't use bool pairwise,
            // just set the pairwirse to true and let it pass the compile.
			// err = rdev->ops->del_key(&rdev->wiphy, dev, idx, addr);
            err = rdev->ops->del_key(&rdev->wiphy, dev, idx, true, addr);
            // End Add by Henry
		}
	...
	if (wdev->current_bss)
        // Add by Henry to sync cfg80211.h->cfg80211_ops with gl_p2p_cfg80211.c
        // mtk_p2p_cfg80211_add_key of MT5931_MP_Linux_P2P_W1233_V1.0 infact doesn't use bool pairwise,
        // just set the pairwirse to true and let it pass the compile.
		// err = rdev->ops->add_key(&rdev->wiphy, dev, idx, addr, params);
        err = rdev->ops->add_key(&rdev->wiphy, dev, idx, true, addr, params);
	if (err)
		return err;
	...
	if ((params->cipher == WLAN_CIPHER_SUITE_WEP40 ||
		...
		if (wdev->current_bss) {
            ...
            // Add by Henry to sync cfg80211.h->cfg80211_ops with gl_p2p_cfg80211.c
            // mtk_p2p_cfg80211_set_default_key of MT5931_MP_Linux_P2P_W1233_V1.0 doesn't use bool unicast, bool multicast,
            // just set the bool unicast, bool multicast to true and let it pass the compile.
