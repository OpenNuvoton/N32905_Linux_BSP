...
struct w55fa93adc_audio {
	...
	unsigned int edma_channel; 
};

extern struct w55fa93adc_audio *g_pw55fa93_adc_data;
extern struct snd_soc_dai w55fa93adc_cpu_dai;
extern struct snd_soc_platform w55fa93adc_soc_platform;
